...
{ 
	...
	string as("My name is mayank");
	int pos=as.find("m");//find position from starting
	cout<<pos<<" "<<as[pos]<<endl;
	cout<<as.rfind("m")<<" "<<as[as.rfind("m")]<<endl;
	sort(as.begin(),as.end());//sorting of string
	cout<<as<<endl;
	as[3]=toupper(as[3]);
	cout<<as<<endl;
